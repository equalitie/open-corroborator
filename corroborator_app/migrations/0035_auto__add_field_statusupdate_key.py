...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StatusUpdate.key'
        db.add_column(u'corroborator_app_statusupdate', 'key',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StatusUpdate.key'
        db.delete_column(u'corroborator_app_statusupdate', 'key')
