...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CrimeCategory.category_ar'
        db.delete_column(u'corroborator_app_crimecategory', 'category_ar')

        # Deleting field 'CrimeCategory.category_en'
        db.delete_column(u'corroborator_app_crimecategory', 'category_en')

        # Adding field 'CrimeCategory.name_en'
        db.add_column(u'corroborator_app_crimecategory', 'name_en',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CrimeCategory.name_ar'
        db.add_column(u'corroborator_app_crimecategory', 'name_ar',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Actor.sex_ar'
        db.alter_column(u'corroborator_app_actor', 'sex_ar', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'Actor.age_ar'
        db.alter_column(u'corroborator_app_actor', 'age_ar', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'Actor.sex_en'
        db.alter_column(u'corroborator_app_actor', 'sex_en', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'Actor.civilian_ar'
        db.alter_column(u'corroborator_app_actor', 'civilian_ar', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'Actor.age_en'
        db.alter_column(u'corroborator_app_actor', 'age_en', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'Actor.civilian_en'
        db.alter_column(u'corroborator_app_actor', 'civilian_en', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

    def backwards(self, orm):
        # Adding field 'CrimeCategory.category_ar'
        db.add_column(u'corroborator_app_crimecategory', 'category_ar',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CrimeCategory.category_en'
        db.add_column(u'corroborator_app_crimecategory', 'category_en',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'CrimeCategory.name_en'
        db.delete_column(u'corroborator_app_crimecategory', 'name_en')

        # Deleting field 'CrimeCategory.name_ar'
        db.delete_column(u'corroborator_app_crimecategory', 'name_ar')


        # Changing field 'Actor.sex_ar'
        db.alter_column(u'corroborator_app_actor', 'sex_ar', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Actor.age_ar'
        db.alter_column(u'corroborator_app_actor', 'age_ar', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Actor.sex_en'
        db.alter_column(u'corroborator_app_actor', 'sex_en', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Actor.civilian_ar'
        db.alter_column(u'corroborator_app_actor', 'civilian_ar', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Actor.age_en'
        db.alter_column(u'corroborator_app_actor', 'age_en', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Actor.civilian_en'
        db.alter_column(u'corroborator_app_actor', 'civilian_en', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
