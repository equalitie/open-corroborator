...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MonitorUpdate'
        db.create_table(u'corroborator_app_monitorupdate', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('update_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'corroborator_app', ['MonitorUpdate'])


    def backwards(self, orm):
        # Deleting model 'MonitorUpdate'
        db.delete_table(u'corroborator_app_monitorupdate')
