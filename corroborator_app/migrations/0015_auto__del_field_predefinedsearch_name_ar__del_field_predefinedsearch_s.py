...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PredefinedSearch.name_ar'
        db.delete_column(u'corroborator_app_predefinedsearch', 'name_ar')

        # Deleting field 'PredefinedSearch.search_request'
        db.delete_column(u'corroborator_app_predefinedsearch', 'search_request')

        # Deleting field 'PredefinedSearch.name_en'
        db.delete_column(u'corroborator_app_predefinedsearch', 'name_en')

        # Deleting field 'PredefinedSearch.search_type'
        db.delete_column(u'corroborator_app_predefinedsearch', 'search_type')


    def backwards(self, orm):
        # Adding field 'PredefinedSearch.name_ar'
        db.add_column(u'corroborator_app_predefinedsearch', 'name_ar',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'PredefinedSearch.search_request'
        db.add_column(u'corroborator_app_predefinedsearch', 'search_request',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PredefinedSearch.name_en'
        db.add_column(u'corroborator_app_predefinedsearch', 'name_en',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'PredefinedSearch.search_type'
        db.add_column(u'corroborator_app_predefinedsearch', 'search_type',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)
