...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Comment.status'
        db.alter_column(u'corroborator_app_comment', 'status_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['corroborator_app.StatusUpdate']))
