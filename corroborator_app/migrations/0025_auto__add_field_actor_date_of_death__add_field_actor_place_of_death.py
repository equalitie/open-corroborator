...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Actor.date_of_death'
        db.add_column(u'corroborator_app_actor', 'date_of_death',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Actor.place_of_death'
        db.add_column(u'corroborator_app_actor', 'place_of_death',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='place_of_death', null=True, to=orm['corroborator_app.Location']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Actor.date_of_death'
        db.delete_column(u'corroborator_app_actor', 'date_of_death')

        # Deleting field 'Actor.place_of_death'
        db.delete_column(u'corroborator_app_actor', 'place_of_death_id')
