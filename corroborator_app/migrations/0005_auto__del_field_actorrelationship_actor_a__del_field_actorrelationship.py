...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ActorRelationship.actor_a'
        db.delete_column(u'corroborator_app_actorrelationship', 'actor_a_id')

        # Deleting field 'ActorRelationship.actor_b'
        db.delete_column(u'corroborator_app_actorrelationship', 'actor_b_id')

        # Adding field 'ActorRelationship.actor'
        db.add_column(u'corroborator_app_actorrelationship', 'actor',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='actor_b', null=True, to=orm['corroborator_app.Actor']),
                      keep_default=False)

        # Adding M2M table for field actor_relationships on 'Actor'
        m2m_table_name = db.shorten_name(u'corroborator_app_actor_actor_relationships')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('actor', models.ForeignKey(orm[u'corroborator_app.actor'], null=False)),
            ('actorrelationship', models.ForeignKey(orm[u'corroborator_app.actorrelationship'], null=False))
        ))
        db.create_unique(m2m_table_name, ['actor_id', 'actorrelationship_id'])


    def backwards(self, orm):
        # Adding field 'ActorRelationship.actor_a'
        db.add_column(u'corroborator_app_actorrelationship', 'actor_a',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='actor_a', null=True, to=orm['corroborator_app.Actor'], blank=True),
                      keep_default=False)

        # Adding field 'ActorRelationship.actor_b'
        db.add_column(u'corroborator_app_actorrelationship', 'actor_b',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='actor_b', null=True, to=orm['corroborator_app.Actor'], blank=True),
                      keep_default=False)

        # Deleting field 'ActorRelationship.actor'
        db.delete_column(u'corroborator_app_actorrelationship', 'actor_id')

        # Removing M2M table for field actor_relationships on 'Actor'
        db.delete_table(db.shorten_name(u'corroborator_app_actor_actor_relationships'))
