...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Media.media_thumb_file'
        db.add_column(u'corroborator_app_media', 'media_thumb_file',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Media.media_thumb_file'
        db.delete_column(u'corroborator_app_media', 'media_thumb_file')
