...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PredefinedSearch.search_title'
        db.add_column(u'corroborator_app_predefinedsearch', 'search_title',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PredefinedSearch.search_string'
        db.add_column(u'corroborator_app_predefinedsearch', 'search_string',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PredefinedSearch.actor_filters'
        db.add_column(u'corroborator_app_predefinedsearch', 'actor_filters',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PredefinedSearch.incident_filters'
        db.add_column(u'corroborator_app_predefinedsearch', 'incident_filters',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PredefinedSearch.bulletin_filters'
        db.add_column(u'corroborator_app_predefinedsearch', 'bulletin_filters',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'PredefinedSearch.search_type'
        db.alter_column(u'corroborator_app_predefinedsearch', 'search_type', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):
        # Deleting field 'PredefinedSearch.search_title'
        db.delete_column(u'corroborator_app_predefinedsearch', 'search_title')

        # Deleting field 'PredefinedSearch.search_string'
        db.delete_column(u'corroborator_app_predefinedsearch', 'search_string')

        # Deleting field 'PredefinedSearch.actor_filters'
        db.delete_column(u'corroborator_app_predefinedsearch', 'actor_filters')

        # Deleting field 'PredefinedSearch.incident_filters'
        db.delete_column(u'corroborator_app_predefinedsearch', 'incident_filters')

        # Deleting field 'PredefinedSearch.bulletin_filters'
        db.delete_column(u'corroborator_app_predefinedsearch', 'bulletin_filters')


        # Changing field 'PredefinedSearch.search_type'
        db.alter_column(u'corroborator_app_predefinedsearch', 'search_type', self.gf('django.db.models.fields.CharField')(default='', max_length=255))
    ...
    models = {
        ...
        u'corroborator_app.predefinedsearch': {
            ...
            'search_type': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
