...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SolrUpdate.update_timestamp'
        db.alter_column(u'corroborator_app_solrupdate', 'update_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

    def backwards(self, orm):

        # Changing field 'SolrUpdate.update_timestamp'
        db.alter_column(u'corroborator_app_solrupdate', 'update_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
