...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field ref_bulletins on 'Incident'
        m2m_table_name = db.shorten_name(u'corroborator_app_incident_ref_bulletins')
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field ref_bulletins on 'Incident'
        db.delete_table(db.shorten_name(u'corroborator_app_incident_ref_bulletins'))
