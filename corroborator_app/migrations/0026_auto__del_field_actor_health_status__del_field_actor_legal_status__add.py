...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Actor.health_status'
        db.delete_column(u'corroborator_app_actor', 'health_status')

        # Deleting field 'Actor.legal_status'
        db.delete_column(u'corroborator_app_actor', 'legal_status')

        # Adding field 'Actor.date_of_disappearance'
        db.add_column(u'corroborator_app_actor', 'date_of_disappearance',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Actor.date_of_return'
        db.add_column(u'corroborator_app_actor', 'date_of_return',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Actor.date_of_detention'
        db.add_column(u'corroborator_app_actor', 'date_of_detention',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Actor.legal_status_en'
        db.add_column(u'corroborator_app_actor', 'legal_status_en',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Actor.legal_status_ar'
        db.add_column(u'corroborator_app_actor', 'legal_status_ar',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Actor.health_status_en'
        db.add_column(u'corroborator_app_actor', 'health_status_en',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Actor.health_status_ar'
        db.add_column(u'corroborator_app_actor', 'health_status_ar',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Actor.family_status_en'
        db.add_column(u'corroborator_app_actor', 'family_status_en',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Actor.family_status_ar'
        db.add_column(u'corroborator_app_actor', 'family_status_ar',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Actor.cause_of_death_en'
        db.add_column(u'corroborator_app_actor', 'cause_of_death_en',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Actor.cause_of_death_ar'
        db.add_column(u'corroborator_app_actor', 'cause_of_death_ar',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Actor.disappearance_location'
        db.add_column(u'corroborator_app_actor', 'disappearance_location',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['corroborator_app.Location'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Actor.health_status'
        db.add_column(u'corroborator_app_actor', 'health_status',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Actor.legal_status'
        db.add_column(u'corroborator_app_actor', 'legal_status',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Actor.date_of_disappearance'
        db.delete_column(u'corroborator_app_actor', 'date_of_disappearance')

        # Deleting field 'Actor.date_of_return'
        db.delete_column(u'corroborator_app_actor', 'date_of_return')

        # Deleting field 'Actor.date_of_detention'
        db.delete_column(u'corroborator_app_actor', 'date_of_detention')

        # Deleting field 'Actor.legal_status_en'
        db.delete_column(u'corroborator_app_actor', 'legal_status_en')

        # Deleting field 'Actor.legal_status_ar'
        db.delete_column(u'corroborator_app_actor', 'legal_status_ar')

        # Deleting field 'Actor.health_status_en'
        db.delete_column(u'corroborator_app_actor', 'health_status_en')

        # Deleting field 'Actor.health_status_ar'
        db.delete_column(u'corroborator_app_actor', 'health_status_ar')

        # Deleting field 'Actor.family_status_en'
        db.delete_column(u'corroborator_app_actor', 'family_status_en')

        # Deleting field 'Actor.family_status_ar'
        db.delete_column(u'corroborator_app_actor', 'family_status_ar')

        # Deleting field 'Actor.cause_of_death_en'
        db.delete_column(u'corroborator_app_actor', 'cause_of_death_en')

        # Deleting field 'Actor.cause_of_death_ar'
        db.delete_column(u'corroborator_app_actor', 'cause_of_death_ar')

        # Deleting field 'Actor.disappearance_location'
        db.delete_column(u'corroborator_app_actor', 'disappearance_location_id')
