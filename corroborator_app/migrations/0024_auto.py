...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field actor_comments on 'Actor'
        m2m_table_name = db.shorten_name(u'corroborator_app_actor_actor_comments')
        ...
        db.create_unique(m2m_table_name, ['actor_id', 'comment_id'])


    def backwards(self, orm):
        # Removing M2M table for field actor_comments on 'Actor'
        db.delete_table(db.shorten_name(u'corroborator_app_actor_actor_comments'))
