...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'corroborator_app_relationtype', (
        ...
        db.send_create_signal(u'corroborator_app', ['RelationType'])

        # Adding model 'RoleType'
        db.create_table(u'corroborator_app_roletype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name_en', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('name_ar', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('description_en', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ...
        db.send_create_signal(u'corroborator_app', ['RoleType'])

        # Adding field 'Actor.description_en'
        db.add_column(u'corroborator_app_actor', 'description_en',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Actor.description_ar'
        db.add_column(u'corroborator_app_actor', 'description_ar',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'ActorRole.role'
        db.add_column(u'corroborator_app_actorrole', 'role',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['corroborator_app.RoleType'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'ActorRole.relation'
        db.add_column(u'corroborator_app_actorrole', 'relation',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['corroborator_app.RelationType'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'RelationType'
        db.delete_table(u'corroborator_app_relationtype')

        # Deleting model 'RoleType'
        db.delete_table(u'corroborator_app_roletype')

        # Deleting field 'Actor.description_en'
        db.delete_column(u'corroborator_app_actor', 'description_en')

        # Deleting field 'Actor.description_ar'
        db.delete_column(u'corroborator_app_actor', 'description_ar')

        # Deleting field 'ActorRole.role'
        db.delete_column(u'corroborator_app_actorrole', 'role_id')

        # Deleting field 'ActorRole.relation'
        db.delete_column(u'corroborator_app_actorrole', 'relation_id')
