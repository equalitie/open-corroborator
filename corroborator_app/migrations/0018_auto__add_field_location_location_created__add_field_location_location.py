...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Location.location_created'
        db.add_column(u'corroborator_app_location', 'location_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 9, 26, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Location.location_modified'
        db.add_column(u'corroborator_app_location', 'location_modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 9, 26, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Actor.actor_modified'
        db.add_column(u'corroborator_app_actor', 'actor_modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 9, 26, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Incident.incident_modified'
        db.add_column(u'corroborator_app_incident', 'incident_modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 9, 26, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Bulletin.bulletin_modified'
        db.add_column(u'corroborator_app_bulletin', 'bulletin_modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 9, 26, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Location.location_created'
        db.delete_column(u'corroborator_app_location', 'location_created')

        # Deleting field 'Location.location_modified'
        db.delete_column(u'corroborator_app_location', 'location_modified')

        # Deleting field 'Actor.actor_modified'
        db.delete_column(u'corroborator_app_actor', 'actor_modified')

        # Deleting field 'Incident.incident_modified'
        db.delete_column(u'corroborator_app_incident', 'incident_modified')

        # Deleting field 'Bulletin.bulletin_modified'
        db.delete_column(u'corroborator_app_bulletin', 'bulletin_modified')
