...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field bulletin_imported_comments on 'Bulletin'
        m2m_table_name = db.shorten_name(u'corroborator_app_bulletin_bulletin_imported_comments')
    ...
    def backwards(self, orm):
        # Removing M2M table for field bulletin_imported_comments on 'Bulletin'
        db.delete_table(db.shorten_name(u'corroborator_app_bulletin_bulletin_imported_comments'))
