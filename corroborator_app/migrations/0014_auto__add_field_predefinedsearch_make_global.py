...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PredefinedSearch.make_global'
        db.add_column(u'corroborator_app_predefinedsearch', 'make_global',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PredefinedSearch.make_global'
        db.delete_column(u'corroborator_app_predefinedsearch', 'make_global')
