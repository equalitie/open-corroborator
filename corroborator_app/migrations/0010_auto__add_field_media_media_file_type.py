...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Media.media_file_type'
        db.add_column(u'corroborator_app_media', 'media_file_type',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Media.media_file_type'
        db.delete_column(u'corroborator_app_media', 'media_file_type')
