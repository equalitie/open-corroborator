...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Incident.deleted'
        db.add_column(u'corroborator_app_incident', 'deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Bulletin.deleted'
        db.add_column(u'corroborator_app_bulletin', 'deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Actor.deleted'
        db.add_column(u'corroborator_app_actor', 'deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Incident.deleted'
        db.delete_column(u'corroborator_app_incident', 'deleted')

        # Deleting field 'Bulletin.deleted'
        db.delete_column(u'corroborator_app_bulletin', 'deleted')

        # Deleting field 'Actor.deleted'
        db.delete_column(u'corroborator_app_actor', 'deleted')
