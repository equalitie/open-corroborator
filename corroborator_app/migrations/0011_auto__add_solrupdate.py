...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SolrUpdate'
        db.create_table(u'corroborator_app_solrupdate', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('update_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'corroborator_app', ['SolrUpdate'])


    def backwards(self, orm):
        # Deleting model 'SolrUpdate'
        db.delete_table(u'corroborator_app_solrupdate')
    ...
    models = {
        ...
        u'corroborator_app.solrupdate': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'update_timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
