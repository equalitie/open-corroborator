...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Actor.source_site'
        db.delete_column(u'corroborator_app_actor', 'source_site')

        # Adding field 'Actor.seq_order'
        db.add_column(u'corroborator_app_actor', 'seq_order',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Bulletin.seq_order'
        db.add_column(u'corroborator_app_bulletin', 'seq_order',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Actor.source_site'
        db.add_column(u'corroborator_app_actor', 'source_site',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Actor.seq_order'
        db.delete_column(u'corroborator_app_actor', 'seq_order')

        # Deleting field 'Bulletin.seq_order'
        db.delete_column(u'corroborator_app_bulletin', 'seq_order')
