...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Actor.sex_ar'
        db.delete_column(u'corroborator_app_actor', 'sex_ar')

        # Deleting field 'Actor.sex_en'
        db.delete_column(u'corroborator_app_actor', 'sex_en')

        # Deleting field 'Actor.civilian_ar'
        db.delete_column(u'corroborator_app_actor', 'civilian_ar')

        # Deleting field 'Actor.civilian_en'
        db.delete_column(u'corroborator_app_actor', 'civilian_en')

        # Deleting field 'Actor.age_ar'
        db.delete_column(u'corroborator_app_actor', 'age_ar')

        # Deleting field 'Actor.age_en'
        db.delete_column(u'corroborator_app_actor', 'age_en')

        # Adding field 'Actor.age'
        db.add_column(u'corroborator_app_actor', 'age',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, db_column='age_en', blank=True),
                      keep_default=False)

        # Adding field 'Actor.sex'
        db.add_column(u'corroborator_app_actor', 'sex',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, db_column='sex_en', blank=True),
                      keep_default=False)

        # Adding field 'Actor.civilian'
        db.add_column(u'corroborator_app_actor', 'civilian',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, db_column='civilian_en', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Actor.sex_ar'
        db.add_column(u'corroborator_app_actor', 'sex_ar',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Actor.sex_en'
        db.add_column(u'corroborator_app_actor', 'sex_en',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Actor.civilian_ar'
        db.add_column(u'corroborator_app_actor', 'civilian_ar',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Actor.civilian_en'
        db.add_column(u'corroborator_app_actor', 'civilian_en',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Actor.age_ar'
        db.add_column(u'corroborator_app_actor', 'age_ar',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Actor.age_en'
        db.add_column(u'corroborator_app_actor', 'age_en',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Deleting field 'Actor.age'
        db.delete_column(u'corroborator_app_actor', 'age_en')

        # Deleting field 'Actor.sex'
        db.delete_column(u'corroborator_app_actor', 'sex_en')

        # Deleting field 'Actor.civilian'
        db.delete_column(u'corroborator_app_actor', 'civilian_en')
