...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ActorStatus'
        db.create_table(u'corroborator_app_actorstatus', (
        ...
        db.send_create_signal(u'corroborator_app', ['ActorStatus'])

        # Adding model 'EventType'
        db.create_table(u'corroborator_app_eventtype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'corroborator_app', ['EventType'])
        ...
        # Adding M2M table for field labels on 'Actor'
        m2m_table_name = db.shorten_name(u'corroborator_app_actor_labels')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('actor', models.ForeignKey(orm[u'corroborator_app.actor'], null=False)),
            ('label', models.ForeignKey(orm[u'corroborator_app.label'], null=False))
        ))
        db.create_unique(m2m_table_name, ['actor_id', 'label_id'])

        # Adding M2M table for field sources on 'Actor'
        m2m_table_name = db.shorten_name(u'corroborator_app_actor_sources')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('actor', models.ForeignKey(orm[u'corroborator_app.actor'], null=False)),
            ('source', models.ForeignKey(orm[u'corroborator_app.source'], null=False))
        ))
        db.create_unique(m2m_table_name, ['actor_id', 'source_id'])

        # Adding field 'TimeInfo.event_location'
        db.add_column(u'corroborator_app_timeinfo', 'event_location',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['corroborator_app.Location'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'TimeInfo.event_type'
        db.add_column(u'corroborator_app_timeinfo', 'event_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['corroborator_app.EventType'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ActorStatus'
        db.delete_table(u'corroborator_app_actorstatus')

        # Deleting model 'EventType'
        db.delete_table(u'corroborator_app_eventtype')

        # Deleting field 'Actor.actor_status'
        db.delete_column(u'corroborator_app_actor', 'actor_status_id')

        # Removing M2M table for field labels on 'Actor'
        db.delete_table(db.shorten_name(u'corroborator_app_actor_labels'))

        # Removing M2M table for field sources on 'Actor'
        db.delete_table(db.shorten_name(u'corroborator_app_actor_sources'))

        # Deleting field 'TimeInfo.event_location'
        db.delete_column(u'corroborator_app_timeinfo', 'event_location_id')

        # Deleting field 'TimeInfo.event_type'
        db.delete_column(u'corroborator_app_timeinfo', 'event_type_id')
    ...
    models = {
        ...
        u'corroborator_app.actor': {
            ...
            'actor_status': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['corroborator_app.ActorStatus']", 'null': 'True', 'blank': 'True'}),
