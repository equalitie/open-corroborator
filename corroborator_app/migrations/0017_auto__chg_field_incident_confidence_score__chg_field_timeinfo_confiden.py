...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Incident.confidence_score'
        db.alter_column(u'corroborator_app_incident', 'confidence_score', self.gf('django.db.models.fields.IntegerField')(max_length=3, null=True))

        # Changing field 'TimeInfo.confidence_score'
        db.alter_column(u'corroborator_app_timeinfo', 'confidence_score', self.gf('django.db.models.fields.IntegerField')(max_length=3, null=True))

        # Changing field 'Bulletin.confidence_score'
        db.alter_column(u'corroborator_app_bulletin', 'confidence_score', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Incident.confidence_score'
        db.alter_column(u'corroborator_app_incident', 'confidence_score', self.gf('django.db.models.fields.IntegerField')(default='', max_length=3))

        # Changing field 'TimeInfo.confidence_score'
        db.alter_column(u'corroborator_app_timeinfo', 'confidence_score', self.gf('django.db.models.fields.IntegerField')(default='', max_length=3))

        # Changing field 'Bulletin.confidence_score'
        db.alter_column(u'corroborator_app_bulletin', 'confidence_score', self.gf('django.db.models.fields.IntegerField')(default=''))
