...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TimeInfo.time_from'
        db.alter_column(u'corroborator_app_timeinfo', 'time_from', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'TimeInfo.time_to'
        db.alter_column(u'corroborator_app_timeinfo', 'time_to', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'TimeInfo.time_from'
        db.alter_column(u'corroborator_app_timeinfo', 'time_from', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 7, 29, 0, 0)))

        # Changing field 'TimeInfo.time_to'
        db.alter_column(u'corroborator_app_timeinfo', 'time_to', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 7, 29, 0, 0)))
