...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Actor.origin_id'
        db.add_column(u'corroborator_app_actor', 'origin_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Actor.age_numeric'
        db.add_column(u'corroborator_app_actor', 'age_numeric',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Actor.family_name_en'
        db.add_column(u'corroborator_app_actor', 'family_name_en',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Actor.family_name_ar'
        db.add_column(u'corroborator_app_actor', 'family_name_ar',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Actor.national_id_card'
        db.add_column(u'corroborator_app_actor', 'national_id_card',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Actor.national_number'
        db.add_column(u'corroborator_app_actor', 'national_number',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)
        ...
        # Adding field 'Bulletin.origin_id'
        db.add_column(u'corroborator_app_bulletin', 'origin_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Actor.origin_id'
        db.delete_column(u'corroborator_app_actor', 'origin_id')

        # Deleting field 'Actor.age_numeric'
        db.delete_column(u'corroborator_app_actor', 'age_numeric')

        # Deleting field 'Actor.family_name_en'
        db.delete_column(u'corroborator_app_actor', 'family_name_en')

        # Deleting field 'Actor.family_name_ar'
        db.delete_column(u'corroborator_app_actor', 'family_name_ar')

        # Deleting field 'Actor.national_id_card'
        db.delete_column(u'corroborator_app_actor', 'national_id_card')

        # Deleting field 'Actor.national_number'
        db.delete_column(u'corroborator_app_actor', 'national_number')
        ...
        # Deleting field 'Bulletin.origin_id'
        db.delete_column(u'corroborator_app_bulletin', 'origin_id')
    ...
    models = {
        ...
        u'corroborator_app.actor': {
            ...
            'health_status': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'legal_status': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
        ...
        u'corroborator_app.location': {
            ...
            'location_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'location_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
