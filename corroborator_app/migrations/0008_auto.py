...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field actors_role on 'Actor'
        m2m_table_name = db.shorten_name(u'corroborator_app_actor_actors_role')
        ...
        db.create_unique(m2m_table_name, ['actor_id', 'actorrole_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field actors_role on 'Actor'
        db.delete_table(db.shorten_name(u'corroborator_app_actor_actors_role'))
